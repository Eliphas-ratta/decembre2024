...
function updateInnerHTML(elemHTML, text) {
...
function tcompareValues(userAnswer) {

}

//################################################################//
//                                                                //
//PERMET DE CAPTER LEVENEMENT CLICK SUR LES BOUTON PAIRE OU IMPAIR//
//                                                                //
//################################################################//
...
for(let i = 0; i < LIST_BUTTONS_ODD_OR_EVEN.length; i++) {
    ...
    LIST_BUTTONS_ODD_OR_EVEN[i].addEventListener("click", function() {
        ...
        //si je vuex recuperer la list de classes de mon objet html
        let listClass = this.classList;
        let secondClass = listClass[1];

        // si j'ai clicker sur un elment block qui a une classe qui commence par L => selectlevel
        // si j'ai clicker sur un elment block qui a une classe qui commence par h => selectHero
        // si j'ai clicker sur un elment block qui a une classe qui commence par e => handleEncounter
